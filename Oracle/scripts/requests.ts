...
async function main() {
    ...
    const test_id = await request.callStatic.requestPrice("MSFT",11 , -1600000000000123n, 10100001010101000n, ["this is a test", "array of strings"]);
    console.log(`test_id: ${JSON.stringify(test_id, null, 2)}`);
    const request_txn = await request.requestPrice("MSFT",11 , -1600000000000123n, 10100001010101000n, ["this is a test", "array of strings"]);
